<script lang="ts">
	...
	function onUiPlayShowBackButtonChange(
		...
		PersistentStoreService.userInterface.play.showBackButton.set(e.currentTarget.checked);
		ToastService.info(`Play Back button ${e.currentTarget.checked ? 'enabled' : 'disabled'}`);
	}
	...
	function onUiPlayShowVolumeChange(
		...
		PersistentStoreService.userInterface.play.showVolume.set(e.currentTarget.checked);
		ToastService.info(`Play Volume ${e.currentTarget.checked ? 'enabled' : 'disabled'}`);
	}
	...
	function onUiShowRepeatButtonChange(
		...
		PersistentStoreService.userInterface.showRepeatButton.set(e.currentTarget.checked);
		ToastService.info(`Repeat button ${e.currentTarget.checked ? 'enabled' : 'disabled'}`);
	}
	...
	function onUiShowShuffleButtonChange(
		...
		PersistentStoreService.userInterface.showShuffleButton.set(e.currentTarget.checked);
		ToastService.info(`Shuffle button ${e.currentTarget.checked ? 'enabled' : 'disabled'}`);
	}
</script>
