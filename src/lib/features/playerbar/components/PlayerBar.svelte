...
<div
	class="animate__animated animate__slideInUp absolute bottom-0 w-full px-3 pt-3"
...
>
	...
	<View class="rounded-full bg-gray-400/35 px-3 py-2 hover:px-4 hover:py-3" glassEnableBlur={true}>
