...
async function onLayoutAnimationEnd(){
    ...
    console.log('Nyata: ' + pageGotoShowCounter);
...
{#if isAppReady}
    <AnimatedBackground />
{/if}
<div class={`w-screen h-screen fixed scrollbar-hidden animate__animated ${$pageGotoShow ? 'animate__fadeIn' : 'animate__fadeOut'}`}
