...
export default {
	...
	theme: {
		extend: {
			...
			"2xl-mdpi": { raw: "(min-width: 1536px) and (max-resolution: 1.0dppx)" },
			...
			"2xl-hdpi": { raw: "(min-width: 1536px) and (min-resolution: 1.01dppx)" },

			"md-xhdpi": { raw: "(min-width: 768px) and (min-resolution: 2.01dppx)" },
			"lg-xhdpi": { raw: "(min-width: 1024px) and (min-resolution: 2.01dppx)" },
			"xl-xhdpi": { raw: "(min-width: 1280px) and (min-resolution: 2.01dppx)" },
			"2xl-xhdpi": { raw: "(min-width: 1536px) and (min-resolution: 2.01dppx)" },
			},
		},
		// animatedSettings: {
		//     classes: ["fadeIn"],
